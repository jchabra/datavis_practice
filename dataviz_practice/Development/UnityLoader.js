...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'dataviz_practice.data';
    var REMOTE_PACKAGE_BASE = 'dataviz_practice.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2473856;
      var PACKAGE_UUID = 'fb6b42b8-0464-45e4-b252-6c79521965e3';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 135750, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(135750, 135769, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(135769, 135935, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(135935, 1571259, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1571259, 2446231, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2446231, 2473856, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_dataviz_practice.data');

    };
    Module['addRunDependency']('datafile_dataviz_practice.data');
